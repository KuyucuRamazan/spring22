...
public class StringBuilder01 {
   /* 1) String class is "immutable" but sometimes we need "mutable" Strings because of that
    ...
    7)String Class and all wrapper classes are immutable. Integer, double, long...etc(Arrays classes are mutable)
 ...
 */
   public static void main(String[] args) {
       ...
       String accountHoulder1="Jack";
       String accountHoulder2="Jack";
       String accountHoulder3="Jack";
       ...
       System.out.println("equals: "+u.equals((t)));
       ...
       System.out.println("capacitySb2: "+capacitySb2);
       ...
       //How  to convert a String to a StringBuilder(str);
       String str="Java";
       ...
       String newStr=sb9.substring(5,7);
       System.out.println("sb9: "+sb9);//Method come from "immutable class" can not update the original value even in mutable class.
