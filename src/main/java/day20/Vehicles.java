...
/*
        ...
        4)What are the differences between "Construtors" and "methods"?
        ...
        iii)The name of "constructors" must match with the name of the Class, but"methods" can use any names.
