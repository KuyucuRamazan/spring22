...
public class Day05Modulus {
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        //Ask user to enter his/her birth year, then print just last two digits on the digits
        ...
        //Ask user to enter three digits integer to find the sum of the digits.
