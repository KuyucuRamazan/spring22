...
public class MultidimensionalArrays01 {
    public static void main(String[] args) {
        ...
        //Example 2: Type code to find the total number of elements
...
int totalNumOfEl=0;
        ...
        String[][] crr={{"Java","is"},{"very", "easy","to","learn"},{"if","you","study","very", "hard"}};
        int numOfEl =0;
        for(String[] w:crr){
        ...
        //Example 5: Find the sum of the max and min element
        // in an integer multidimensional array
