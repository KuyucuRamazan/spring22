...
public class Fp04 {
    public static void main(String[] args) {
        ...
        System.out.println(sumOfEvenIntInGivenRange(3, 3));
        System.out.println(findSumOfDigitsFromTheIntegersInTheGivenRange(15,13));
    }
    ...
    //2)Create a method to find the
    // multiplication of the integers from 2(inc) to 11(inc)
    public static int getMultFromTwoToEleven(){
        return IntStream.rangeClosed(2,11).reduce(1,Math::multiplyExact);

    }
    //3)Create a method to calculate the factorial of a given
    // number.(5 factorial = 1*2*3*4*5  ==> 5! = 1*2*3*4*5)
    ...
    //4)Create a method to
    // calculate the sum of even integers between given two integers
