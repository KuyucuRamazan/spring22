...
public class Fp05 {
    public static void main(String[] args) {
        ...
        System.out.println(sortCourseWithAvgScoreInAscendingOrderSkipFirstGiven(coursesList, 3));
    }
    //1)Create a method to check if all
    // average scores are greater than given number
    ...
    //2)Create a method to check if at least one of the course
    // names contains given word
...
//3) Create a method to print the course whose average score is highest
    ...
    // according to the average score in ascending order and skip first given
